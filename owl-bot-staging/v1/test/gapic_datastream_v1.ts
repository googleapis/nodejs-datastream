...
describe('v1.DatastreamClient', () => {
    ...
    describe('discoverConnectionProfile', () => {
        it('invokes discoverConnectionProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DiscoverConnectionProfileRequest', ['parent']);
    ...
    describe('getStream', () => {
        it('invokes getStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getStreamObject', () => {
        it('invokes getStreamObject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetStreamObjectRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('lookupStreamObject', () => {
        it('invokes lookupStreamObject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('LookupStreamObjectRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.StreamObject()
    ...
    describe('startBackfillJob', () => {
        it('invokes startBackfillJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StartBackfillJobRequest', ['object']);
    ...
    describe('stopBackfillJob', () => {
        it('invokes stopBackfillJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StopBackfillJobRequest', ['object']);
            request.object = defaultValue1;
            const expectedHeaderRequestParams = `object=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getPrivateConnection', () => {
        it('invokes getPrivateConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetPrivateConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getRoute', () => {
        it('invokes getRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createStream', () => {
        it('invokes createStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateStreamRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateStream', () => {
        it('invokes updateStream without error', async () => {
            ...
            request.stream ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateStreamRequest', ['stream', 'name']);
    ...
    describe('deleteStream', () => {
        it('invokes deleteStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createPrivateConnection', () => {
        it('invokes createPrivateConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreatePrivateConnectionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deletePrivateConnection', () => {
        it('invokes deletePrivateConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeletePrivateConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createRoute', () => {
        it('invokes createRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateRouteRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteRoute', () => {
        it('invokes deleteRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listStreams', () => {
        it('invokes listStreams without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListStreamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listStreamObjects', () => {
        it('invokes listStreamObjects without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListStreamObjectsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('fetchStaticIps', () => {
        it('invokes fetchStaticIps without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('FetchStaticIpsRequest', ['name']);
            request.name = defaultValue1;
    ...
    describe('listPrivateConnections', () => {
        it('invokes listPrivateConnections without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListPrivateConnectionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listRoutes', () => {
        it('invokes listRoutes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRoutesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
